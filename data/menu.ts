...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: { [Language.EN]: 'Coconut', [Language.TH]: 'มะพร้าว', [Language.ZH]: '椰子' }, price: 45 },
      { name: { [Language.EN]: 'Strawberry', [Language.TH]: 'สตรอเบอรี่', [Language.ZH]: '草莓' }, price: 45 },
      { name: { [Language.EN]: 'Blueberry', [Language.TH]: 'บลูเบอรี่', [Language.ZH]: '蓝莓' }, price: 45 },
      { name: { [Language.EN]: 'Raspberry', [Language.TH]: 'ราสเบอรี่', [Language.ZH]: '覆盆子' }, price: 45 },
      { name: { [Language.EN]: 'Banana', [Language.TH]: 'กล้วยหอม', [Language.ZH]: '香蕉' }, price: 45 },
      { name: { [Language.EN]: 'Mango', [Language.TH]: 'มะม่วง', [Language.ZH]: '芒果' }, price: 45 },
      { name: { [Language.EN]: 'Cantaloupe', [Language.TH]: 'แคนตาลูป', [Language.ZH]: '哈密瓜' }, price: 45 },
      { name: { [Language.EN]: 'Avocado', [Language.TH]: 'อโวคาโด', [Language.ZH]: '牛油果' }, price: 45 },
    ],
    addOns: {
  ...
  },
  {
    ...
    items: [
      { name: { [Language.EN]: 'Red Soda', [Language.TH]: 'แดงโซดา', [Language.ZH]: '红苏打' }, price: 35 },
      { name: { [Language.EN]: 'Pineapple', [Language.TH]: 'สับปะรด', [Language.ZH]: '菠萝' }, price: 35 },
      { name: { [Language.EN]: 'Lemon', [Language.TH]: 'มะนาว', [Language.ZH]: '柠檬' }, price: 35 },
      { name: { [Language.EN]: 'Green Apple', [Language.TH]: 'แอปเปิ้ลเขียว', [Language.ZH]: '青苹果' }, price: 35 },
      { name: { [Language.EN]: 'Red Apple', [Language.TH]: 'แอปเปิ้ลแดง', [Language.ZH]: '红苹果' }, price: 35 },
      { name: { [Language.EN]: 'Watermelon', [Language.TH]: 'แตงโม', [Language.ZH]: '西瓜' }, price: 35 },
      { name: { [Language.EN]: 'Guava', [Language.TH]: 'ฝรั่ง', [Language.ZH]: '番石榴' }, price: 35 },
      { name: { [Language.EN]: 'Passionfruit', [Language.TH]: 'เสาวรส', [Language.ZH]: '百香果' }, price: 35 },
      { name: { [Language.EN]: 'Mango Passion', [Language.TH]: 'มะม่วงเสาวรส', [Language.ZH]: '芒果百香果' }, price: 35 },
      { name: { [Language.EN]: 'Mixed Veggie/Fruit', [Language.TH]: 'ผักผลไม้รวม', [Language.ZH]: '混合蔬果' }, price: 35 },
      { name: { [Language.EN]: 'Coconut', [Language.TH]: 'มะพร้าว', [Language.ZH]: '椰子' }, price: 35 },
    ],
  },
  {
    id: 'spicy-smoothies',
    ...
    items: [
      { name: { [Language.EN]: 'Passionfruit Chili Salt', [Language.TH]: 'เสาวรสพริกเกลือ', [Language.ZH]: '百香果辣椒盐' }, price: 40 },
      { name: { [Language.EN]: 'Lemon Chili Salt', [Language.TH]: 'มะนาวพริกเกลือ', [Language.ZH]: '柠檬辣椒盐' }, price: 40 },
      { name: { [Language.EN]: 'Mango Chili Salt', [Language.TH]: 'มะม่วงพริกเกลือ', [Language.ZH]: '芒果辣椒盐' }, price: 40 },
      { name: { [Language.EN]: 'Pineapple Chili Salt', [Language.TH]: 'สับปะรดพริกเกลือ', [Language.ZH]: '菠萝辣椒盐' }, price: 40 },
      { name: { [Language.EN]: 'Guava Chili Salt', [Language.TH]: 'ฝรั่งพริกเกลือ', [Language.ZH]: '番石榴辣椒盐' }, price: 40 },
    ],
  },
  {
    id: 'fruit-tea',
  ...
  },
  {
    ...
    items: [
      { name: { [Language.EN]: 'Fresh Orange Juice', [Language.TH]: 'น้ำส้มคั้นสด', [Language.ZH]: '鲜榨橙汁' }, price: 40 },
      { name: { [Language.EN]: 'Fresh Passionfruit', [Language.TH]: 'น้ำเสาวรส', [Language.ZH]: '鲜榨百香果汁' }, price: 40 },
      { name: { [Language.EN]: 'Lemon Juice', [Language.TH]: 'น้ำมะนาว', [Language.ZH]: '柠檬汁' }, price: 35 },
      { name: { [Language.EN]: 'Passionfruit Juice', [Language.TH]: 'น้ำเสาวรสสด', [Language.ZH]: '百香果汁' }, price: 35 },
      { name: { [Language.EN]: 'Lemon Soda', [Language.TH]: 'น้ำมะนาวโซดา', [Language.ZH]: '柠檬苏打' }, price: 35 },
      { name: { [Language.EN]: 'Honey Lemon', [Language.TH]: 'น้ำผึ้งมะนาว', [Language.ZH]: '蜂蜜柠檬' }, price: 40 },
    ],
  },
  {
    id: 'special-drinks',
